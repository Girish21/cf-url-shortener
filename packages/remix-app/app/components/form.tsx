    ...
    <div className='pt-[10vh]'>
      <RemixForm method='post'>
        <fieldset className='flex flex-col sm:flex-row gap-4 mx-auto'>
          ...
          />
          <button className='bg-violet-600 text-white font-bold rounded-md px-2 py-3 sm:px-3 sm:py-4 focus:outline-none dark:focus-visible:ring-4 dark:ring-offset-2 dark:ring-offset-transparent dark:ring-blue-500 text-lg sm:text-xl shadow-[5px_5px] focus-visible:shadow-[7px_7px] transition-shadow duration-150 ease-out shadow-gray-900 focus-visible:shadow-gray-900 border-2 border-gray-900 dark:border-none'>
            Get URL
          </button>
        </fieldset>
      </RemixForm>
